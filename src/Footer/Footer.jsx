    ...
    return (
        <footer className="footer bg-neutral text-neutral-content p-10">
            ...
            <div className='text-2xl font-medium'>Chapter<span className='text-blue-400'>Vault</span></div>
              ...
              <div className='text-xl font-extrabold'>Give Your Favourite Book Information</div>
               <input className='w-[350px] bg-transparent border-2 border-r-zinc-200 rounded-md text-center h-[35px]' type="text" placeholder='Enter Book Name' />
               <input className='w-[350px] bg-transparent border-2 border-r-zinc-200 rounded-md text-center h-[35px]' type="text" placeholder='Enter Authors Name' />
               <input className='w-[350px] bg-transparent border-2 border-r-zinc-200 rounded-md text-center h-[35px]' type="text" placeholder='Enter Book Category' />
            </nav>
            <nav>
